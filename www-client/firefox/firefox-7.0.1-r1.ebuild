...
# $Header: /var/cvsroot/gentoo-x86/www-client/firefox/firefox-7.0.1.ebuild,v 1.1 2011/10/01 01:38:13 anarchy Exp $
...
IUSE="bindist +crashreporter +ipc pgo system-sqlite +webm +globalmenu"
...
src_prepare() {
	...
	epatch ${FILESDIR}/mozilla-kde-1.patch
	epatch ${FILESDIR}/firefox-kde-1.patch
